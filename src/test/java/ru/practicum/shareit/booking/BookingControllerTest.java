...
public class BookingControllerTest {
    ...
    @Test
    public void shouldReturnBadRequestWhenWrongState() throws Exception {
        mvc.perform(get("/bookings/owner")
                        .contentType(MediaType.APPLICATION_JSON)
                        .characterEncoding(StandardCharsets.UTF_8)
                        .param("state", "Unknown")
    ...
    @Test
    public void shouldReturnBadRequestWhenCreateAndBookingDateInvalid() throws Exception {
        BookingDto invalidDateBookingDto = BookingDto.builder()
                .item(1L)
                .status("WAITING")
                .booker(1L)
        ...
        mvc.perform(post("/bookings")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(mapper.writeValueAsString(invalidDateBookingDto))
                        .characterEncoding(StandardCharsets.UTF_8)
                        .header("X-Sharer-User-Id", 1))
                .andExpect(status().isBadRequest());
